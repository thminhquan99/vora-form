...
import type { VRWidgetBuilderProps, WidgetNode } from './types';
import styles from './VRWidgetBuilder.module.css';
...
export function VRWidgetBuilder({
  name,
  label,
  required = false,
  className,
  id,
}: VRWidgetBuilderProps): React.JSX.Element {
  const field = useVoraField<WidgetNode[]>(name);
