...
import type { PaulyTextProps } from './types';
import styles from './PaulyText.module.css';

/**
 * Uncontrolled text input integrated with PaulyForm via the universal
 * field contract.
 *
...
export function PaulyText({
  ...
  className,
  id,
}: PaulyTextProps): React.JSX.Element {
