...
import type { PaulyDropzoneProps } from './types';
import styles from './PaulyDropzone.module.css';

/**
 * Drag-and-drop file uploader integrated with PaulyForm.
 *
...
export function PaulyDropzone({
  ...
  className,
  id,
}: PaulyDropzoneProps): React.JSX.Element {
  const field = usePaulyField<File[]>(name);
