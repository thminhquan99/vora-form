...
import type { PaulyNodeGraphProps, GraphData, Node as GraphNode } from './types';
import styles from './PaulyNodeGraph.module.css';
...
export function PaulyNodeGraph({
  name,
  label,
  required = false,
  className,
  id,
}: PaulyNodeGraphProps): React.JSX.Element {
  const field = usePaulyField<GraphData>(name);
