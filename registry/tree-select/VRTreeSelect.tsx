...
import type { VRTreeSelectProps, TreeNode } from './types';
import styles from './VRTreeSelect.module.css';
...
export function VRTreeSelect({
  ...
  className,
  id,
}: VRTreeSelectProps): React.JSX.Element {
