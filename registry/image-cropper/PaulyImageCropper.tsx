...
import type { PaulyImageCropperProps, ImageCropData } from './types';
import styles from './PaulyImageCropper.module.css';

export function PaulyImageCropper({
  name,
  label,
  required = false,
  className,
  id,
  aspectRatio,
}: PaulyImageCropperProps): React.JSX.Element {
  const field = usePaulyField<ImageCropData | null>(name);
