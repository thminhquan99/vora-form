...
import type { PaulySignatureProps } from './types';
import styles from './PaulySignature.module.css';
 ...
 */
export function PaulySignature({
  name,
  label,
  penColor = '#000000',
  penWidth = 2,
  ...
  className,
  id,
}: PaulySignatureProps): React.JSX.Element {
