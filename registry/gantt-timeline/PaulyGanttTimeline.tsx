...
import type { PaulyGanttTimelineProps, GanttTask } from './types';
import styles from './PaulyGanttTimeline.module.css';

const MS_PER_DAY = 1000 * 60 * 60 * 24;

export function PaulyGanttTimeline({
  name,
  label,
  required = false,
  className,
  ...
  startDate,
  endDate,
}: PaulyGanttTimelineProps): React.JSX.Element {
  const field = usePaulyField<GanttTask[]>(name);
