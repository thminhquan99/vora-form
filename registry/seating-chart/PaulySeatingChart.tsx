...
import type { PaulySeatingChartProps } from './types';
import styles from './PaulySeatingChart.module.css';

export function PaulySeatingChart({
  name,
  label,
  required = false,
  className,
  id,
  svgContent,
}: PaulySeatingChartProps): React.JSX.Element {
