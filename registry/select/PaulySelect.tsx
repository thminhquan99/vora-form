...
import type { PaulySelectProps } from './types';
import styles from './PaulySelect.module.css';

/**
 * Native `<select>` dropdown integrated with PaulyForm.
 *
...
export function PaulySelect({
  ...
  className,
  id,
}: PaulySelectProps): React.JSX.Element {
