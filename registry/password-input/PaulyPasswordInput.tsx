...
import type { PaulyPasswordInputProps } from './types';
import styles from './PaulyPasswordInput.module.css';
 ...
 */
export function PaulyPasswordInput({
  name,
  label,
  placeholder,
  ...
  className,
  id,
}: PaulyPasswordInputProps): React.JSX.Element {
