...
import type { PaulyComboboxProps } from './types';
import styles from './PaulyCombobox.module.css';

/**
 * Searchable dropdown (combobox) integrated with PaulyForm.
 *
 * ### Composite Widget
 *
...
export function PaulyCombobox({
  ...
  className,
  id,
}: PaulyComboboxProps): React.JSX.Element {
